<template>
  <PortalLayout>
    <NavAccountUnauth slot="nav-right" active="reset"></NavAccountUnauth>
      ...
      <div class="columns">
        <div class="column">
          <BusyBox :disabled="loading" class="validation-form center-form">
            ...
            <div class="sub-title has-text-centered">Verify that it is you by entering the 6 digit code generated by your authenticator app.</div>
